...
function _1p21_bundle_create_admin_error($message,$notice_type = 'error'){
...
if (!class_exists('ACF')){
	...
	_1p21_bundle_create_admin_error($message);
}else{
	...
	// ACF NAV menu Field
		...
		_1p21_sm_create_admin_error('Acf nav field already installed','warning');
	}
	...
	if(!class_exists('ACFQuickEdit')){
		...
		_1p21_sm_create_admin_error('Acf quick edit already installed','warning');
	}
